...
function ajaxDelete(e) {
  ...
  _axios2.default.delete(this.action).then(function (res) {
...
var _delete = __webpack_require__(11);
...
var deleteForms = (0, _bling.$$)("form.delete");
deleteForms.on("submit", _delete2.default);
